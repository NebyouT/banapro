            ...
            <div class="card shadow-sm">
                <div class="card-bodys ">
                    <div class="table-header p-16">
                        <h4><?php echo e(__('Messages List')); ?></h4>
                    </div>
                    <div class="table-top-form p-16-0">
                        <form action="<?php echo e(route('admin.messages.filter')); ?>" method="post" class="filter-form"
                            table="#messages-data">
                            <?php echo csrf_field(); ?>
                ...
                <div class="responsive-table m-0">
                    <table class="table" id="erp-table">
                        ...
                        <tbody id="messages-data" class="searchResults">
                            <?php echo $__env->make('admin.messages.datas', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </tbody>
                    </table>

                    <nav>
                        <ul class="pagination">
                            <li class="page-item"><?php echo e($messages->links('pagination::bootstrap-5')); ?></li>
                        </ul>
                    </nav>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banaeaou/pro.banaeats.com/resources/views/admin/messages/index.blade.php ENDPATH**/ ?>