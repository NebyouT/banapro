                    ...
                    <div class="tab-content mt-3" id="settingsTabContent">
                        <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
                            <div class="settings-box-container">
                                <div>
                                    <a href="<?php echo e(route('admin.settings.index')); ?>" class="text-decoration-none text-dark">
                        ...
                        <div class="tab-pane fade" id="otp" role="tabpanel" aria-labelledby="otp-tab">
                            <div class="order-form-section p-16">
                                ...
                                <form action="<?php echo e(route('admin.manage-settings.store')); ?>" method="post" class="ajaxform">
                                    <?php echo csrf_field(); ?>
                                    <div class="row product-setting-form mt-3">
                                        <div class="d-flex align-items-center mb-3">
                                            <input
                                                ...
                                                name="otp_status"
                                                value="on"
                                                <?php echo e(($otp->value['otp_status'] ?? '') === 'on' ? 'checked' : ''); ?>

                                            >
                                            <label for="otp_status_on" class="custom-top-label">
                                                <?php echo e(__('Verify email with OTP on signup?')); ?>

                                            </label>
                                        </div>

                                        <div class="form-group  otp-expiration-field">
                                            <label class="otp-input-label"><?php echo e(__('Valid Time')); ?></label>
                                            <div class="otp-input-group">
                                                <input type="text" name="otp_expiration_time" placeholder="Ex: 30" value="<?php echo e($otp->value['otp_expiration_time'] ?? ''); ?>" class="otp-input">

                                                <select name="otp_duration_type" class="otp-select">
                                                    <option value="second" <?php echo e(($otp->value['otp_duration_type'] ?? '') === 'second' ? 'selected' : ''); ?>>
                                                        Seconds
                                                    </option>
                                                    <option value="minute" <?php echo e(($otp->value['otp_duration_type'] ?? '') === 'minute' ? 'selected' : ''); ?>>
                                                        Minutes
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center mb-3 mt-3">
                                            <input
                                                ...
                                                name="otp_status"
                                                value="off"
                                                <?php echo e(($otp->value['otp_status'] ?? '') === 'off' ? 'checked' : ''); ?>

                                            >
                                            <label for="otp_status_off" class="custom-top-label">
                                                <?php echo e(__('Verify email without OTP on signup?')); ?>
                        ...
                        <div class="tab-pane fade" id="domain" role="tabpanel" aria-labelledby="domain-tab">
                            <div class="order-form-section p-16">
                                <h4 class="otp-title"><?php echo e(__('Domain Setting')); ?></h4>
                                <form action="<?php echo e(route('admin.domain.setting')); ?>" method="post" class="ajaxform">
                                    <?php echo csrf_field(); ?>
                                    <div class="row product-setting-form mt-3">
                                        <div class="col-lg-12">
                                            <div class="d-flex align-items-center mb-3">
                                                <input type="radio" id="ssl_required" class="delete-checkbox-item multi-delete" name="ssl_required" value="on" <?php echo e(($domain->value['ssl_required'] ?? '') === 'on' ? 'checked' : ''); ?>>
                                                <label for="ssl_required" class="custom-top-label">
                                                    <?php echo e(__('SSL is required.')); ?>

                                                </label>
                                            </div>

                                            <div class="d-flex align-items-center mb-3 mt-3">
                                                <input type="radio" id="ssl_nullable" class="delete-checkbox-item multi-delete" name="ssl_required" value="off" <?php echo e(($domain->value['ssl_required'] ?? '') === 'off' ? 'checked' : ''); ?>>
                                                <label for="ssl_nullable" class="custom-top-label">
                                                    <?php echo e(__('SSL is not required.')); ?>

                                                </label>
                                            </div>

                                            <div class="d-flex align-items-center mb-3">
                                                <input type="radio" id="automatic_approve" class="delete-checkbox-item multi-delete" name="automatic_approve" value="on" <?php echo e(($domain->value['automatic_approve'] ?? '') === 'on' ? 'checked' : ''); ?>>
                                                <label for="automatic_approve" class="custom-top-label">
                                                    <?php echo e(__('Subdomain / Custom domains are allowed automatically.')); ?>

                                                </label>
                                            </div>

                                            <div class="d-flex align-items-center mb-3 mt-3">
                                                <input type="radio" id="domain_not_allowed" class="delete-checkbox-item multi-delete" name="automatic_approve" value="off" <?php echo e(($domain->value['automatic_approve'] ?? '') === 'off' ? 'checked' : ''); ?>>
                                                <label for="domain_not_allowed" class="custom-top-label">
                                                    <?php echo e(__('Subdomain / Custom domains are not allowed automatically.')); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banaeaou/pro.banaeats.com/resources/views/admin/manage-settings/index.blade.php ENDPATH**/ ?>