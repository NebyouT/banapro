<nav class="side-bar relative">
    <div class="side-bar-logo">
        <a href="<?php echo e(route('admin.dashboard.index')); ?>">
            <img
                src="<?php echo e(asset(get_option('general')['admin_logo'] ?? 'assets/images/logo/backend_logo.png')); ?>"alt="Logo">
        </a>
    ...
    <div class="side-bar-manu ">
        <ul>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dashboard-read')): ?>
                <li class="<?php echo e(Request::routeIs('admin.dashboard.index') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.dashboard.index')); ?>" class="active">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('banners-read')): ?>
                <li
                    class="<?php echo e(Request::routeIs('admin.banners.index', 'admin.banners.create', 'admin.banners.edit') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.banners.index')); ?>" class="active">
                        <span class="sidebar-icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('business-read')): ?>
                <li
                    class="<?php echo e(Request::routeIs('admin.business.index', 'admin.business.create', 'admin.business.edit') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.business.index')); ?>" class="active">
                        <span class="sidebar-icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['business-categories-read'])): ?>
                <li class="<?php echo e(Request::routeIs('admin.business-categories.index', 'admin.business-categories.create', 'admin.business-categories.edit') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.business-categories.index')); ?>" class="active">
                        <span class="sidebar-icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <?php endif; ?>
                ...
                <li
                    class="<?php echo e(Request::routeIs('admin.subscription-orders.index') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.subscription-orders.index')); ?>" class="active">
                        <span class="sidebar-icon">
                        ...
                        <?php echo e(__('Subscription Orders')); ?>

                    </a>
                </li>

            <?php if(moduleCheck('CustomDomainAddon')): ?>
            <li class="<?php echo e(Request::routeIs('admin.domains.index', 'admin.domains.create', 'admin.domains.edit') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin.domains.index')); ?>" class="active">
                    <span class="sidebar-icon">
                    ...
                    <?php echo e(__('Domains List')); ?>

                </a>
            </li>
            <?php endif; ?>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['plans-read', 'plans-create'])): ?>
                <li
                    class="dropdown <?php echo e(Route::is('admin.plans.index', 'admin.plans.create', 'admin.plans.edit') ? 'active' : ''); ?>">
                    <a href="#">
                        <span class="sidebar-icon">
                    ...
                    <ul>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('plans-create')): ?>
                            <li><a class="<?php echo e(Route::is('admin.plans.create') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.plans.create')); ?>"><?php echo e(__('Create Plan')); ?></a></li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('plans-read')): ?>
                            <li><a class="<?php echo e(Route::is('admin.plans.index', 'admin.plans.edit') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.plans.index')); ?>"><?php echo e(__('Manage Plans')); ?></a></li>
                        <?php endif; ?>
                    </ul>
                </li>
            <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['users-read'])): ?>
                <li
                    class="dropdown <?php echo e(Request::routeIs('admin.users.index', 'admin.users.create', 'admin.users.edit') ? 'active' : ''); ?>">
                    <a href="#">
                        <span class="sidebar-icon">
                        ...
                        <?php echo e(__('Staff Management')); ?> </a>
                    <ul>
                        <li><a class="<?php echo e(Request::routeIs('admin.users.create') ? 'active' : ''); ?>"
                                href="<?php echo e(route('admin.users.create')); ?>"><?php echo e(__('Create Staff')); ?></a></li>

                        <li><a class="<?php echo e(Request::routeIs('admin.users.index', 'admin.users.edit') ? 'active' : ''); ?>"
                                href="<?php echo e(route('admin.users.index')); ?>"><?php echo e(__('Manage Staff')); ?></a></li>
                    </ul>
                </li>
            <?php endif; ?>

            <?php if(moduleCheck('AffiliateAddon')): ?>
                <li class="dropdown <?php echo e(Request::routeIs('admin.affiliates.index','admin.affiliate-withdrawals.index','admin.affiliate-reports.index') ? 'active' : ''); ?>">
                <a href="#">
                    <span class="sidebar-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                ...
                <ul>
                    <li><a class="<?php echo e(Request::routeIs('admin.affiliates.index') ? 'active' : ''); ?>" href="<?php echo e(route('admin.affiliates.index')); ?>"><?php echo e(__('Affiliate List')); ?></a></li>
                    <li>
                        <a class="<?php echo e(Request::routeIs('admin.affiliate-withdrawals.index') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.affiliate-withdrawals.index')); ?>">
                            <?php echo e(__('Withdraw Request')); ?>

                        </a>
                    </li>
                    <li>
                        <a class="<?php echo e(Request::routeIs('admin.affiliate-reports.index') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.affiliate-reports.index')); ?>">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['subscription-reports-read'])): ?>
                <li class="dropdown <?php echo e(Route::is('admin.subscription-reports.index') ? 'active' : ''); ?>">
                    <a href="#">
                        <span class="sidebar-icon">
                    ...
                    <ul>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('plans-create')): ?>
                            <li><a class="<?php echo e(Route::is('admin.subscription-reports.index') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.subscription-reports.index')); ?>"><?php echo e(__('Subscription Reports')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['messages-read'])): ?>
                <li
                    class="dropdown <?php echo e(Request::routeIs('admin.messages.index', 'admin.messages.create', 'admin.messages.edit') ? 'active' : ''); ?>">
                    <a href="#">
                        <span class="sidebar-icon">
                        ...
                        <?php echo e(__('Messages')); ?> </a>
                    <ul>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('messages-read')): ?>
                            <li><a class="<?php echo e(Request::routeIs('admin.messages.index') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.messages.index')); ?>"><?php echo e(__('Contact Messages')); ?></a></li>
                        <?php endif; ?>
                    </ul>
                </li>
            <?php endif; ?>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['settings-read', 'notifications-read', 'currencies-read', 'sms-read', 'features-read',
                ...
                <li
                    ...
                    <ul>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('settings-read')): ?>
                            <li>
                                <a class="<?php echo e(Request::routeIs('admin.website-settings.index') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.website-settings.index')); ?>"><?php echo e(__('Manage Pages')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faqs-read')): ?>
                            <li>
                                <a class="<?php echo e(Request::routeIs('admin.faqs.create', 'admin.faqs.destroy', 'admin.faqs.edit', 'admin.faqs.index') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.faqs.index')); ?>"><?php echo e(__('Manage FAQs')); ?></a>
                            </li>
                        <?php endif; ?>
                        <li>
                            <a class="<?php echo e(Request::routeIs('admin.term-conditions.index') ? 'active' : ''); ?>"
                                href="<?php echo e(route('admin.term-conditions.index')); ?>"><?php echo e(__('Terms & Conditions')); ?></a>
                        </li>

                        <li>
                            <a class="<?php echo e(Request::routeIs('admin.privacy-policy.index') ? 'active' : ''); ?>"
                                href="<?php echo e(route('admin.privacy-policy.index')); ?>"><?php echo e(__('Privacy & Policy')); ?></a>
                        </li>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('testimonials-read')): ?>
                            <li>
                                <a class="<?php echo e(Request::routeIs('admin.testimonials.index', 'admin.testimonials.create', 'admin.testimonials.edit') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.testimonials.index')); ?>"><?php echo e(__('Testimonials')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('features-read')): ?>
                            <li>
                                <a class="<?php echo e(Request::routeIs('admin.features.index', 'admin.features.create', 'admin.features.edit') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.features.index')); ?>"><?php echo e(__('Features')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('interfaces-read')): ?>
                            <li>
                                <a class="<?php echo e(Request::routeIs('admin.interfaces.index', 'admin.interfaces.create', 'admin.interfaces.edit') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.interfaces.index')); ?>"><?php echo e(__('Interface')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('blogs-read')): ?>
                            <li>
                                <a class="<?php echo e(Request::routeIs('admin.blogs.index', 'admin.blogs.create', 'admin.blogs.edit', 'admin.blogs.filter.comment') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.blogs.index')); ?>"><?php echo e(__('Manage Blogs')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('newsletters-read')): ?>
                            <li>
                                <a class="<?php echo e(Request::routeIs('admin.newsletters.index') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.newsletters.index')); ?>"><?php echo e(__('Newsletters')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['roles-read', 'permissions-read'])): ?>
                <li
                    class="dropdown <?php echo e(Request::routeIs('admin.roles.index', 'admin.roles.create', 'admin.roles.edit', 'admin.permissions.index') ? 'active' : ''); ?>">
                    <a href="#">
                        <span class="sidebar-icon">
                    ...
                    <ul>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles-read')): ?>
                            <li>
                                <a class="<?php echo e(Request::routeIs('admin.roles.index', 'admin.roles.create', 'admin.roles.edit') ? 'active' : ''); ?>"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permissions-read')): ?>
                            <li>
                                <a class="<?php echo e(Request::routeIs('admin.permissions.index') ? 'active' : ''); ?>"
            ...
            <li class="<?php echo e(Request::routeIs('admin.addons.index') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin.addons.index')); ?>" class="active">
                    <span class="sidebar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('settings-read')): ?>
                <li class="<?php echo e(Request::routeIs('admin.manage-settings.index','admin.currencies.index', 'admin.currencies.create', 'admin.currencies.edit','admin.settings.index','admin.system-settings.index','admin.gateways.index','admin.notifications.index') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.manage-settings.index')); ?>" class="active">
                        <span class="sidebar-icon">
    ...
    <?php if($version): ?>
    <div class="text-white text-center mt-4 mb-2 version-text"><?php echo e(__('Version')); ?> : <?php echo e($version); ?></div>
    <?php endif; ?>
</nav>
<?php /**PATH /home/banaeaou/pro.banaeats.com/resources/views/layouts/partials/side-bar.blade.php ENDPATH**/ ?>