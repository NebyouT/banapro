        ...
        <div class="card">
            <div class="card-bodys ">
                ...
                <div class="table-top-form p-16-0">
                    <form action="<?php echo e(route('admin.subscription-orders.filter')); ?>" method="post" class="filter-form" table="#subscriber-data">
                        <?php echo csrf_field(); ?>
            ...
            <div class="responsive-table m-0">
                <table class="table" id="datatable">
                    ...
                    <tbody  id="subscriber-data">
                        <?php echo $__env->make('admin.subscribe-order.datas', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </tbody>
                </table>
            </div>
            <div class="mt-3">
    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5"><?php echo e(__('Are you sure?')); ?></h1>
...
<div class="modal fade" id="subscriber-view-modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5"><?php echo e(__('Subscriber View')); ?></h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="personal-info">
                    ...
                    <div class="row align-items-center mt-3">
                        <div class="col-md-4"><p><?php echo e(__('Gateway Method')); ?></p></div>
                        <div class="col-1">
                            <p>:</p>
                        </div>
                    ...
                    <div class="row align-items-center mt-3">
                        <div class="col-md-4"><p><?php echo e(__('Enroll Date')); ?></p></div>
                        <div class="col-1">
                            <p>:</p>
                        </div>
                    ...
                    <div class="row align-items-center mt-3">
                        <div class="col-md-4"><p><?php echo e(__('Expire date')); ?></p></div>
                        <div class="col-1">
                            <p>:</p>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banaeaou/pro.banaeats.com/resources/views/admin/subscribe-order/index.blade.php ENDPATH**/ ?>